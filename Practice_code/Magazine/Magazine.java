public class Magazine {
    ...
    public Magazine(Magazine currMagazine)
    {
        this.title = currMagazine.title;
        this.publisher = currMagazine.publisher;
        this.issueNumber = currMagazine.issueNumber;
        this.publicationYear = currMagazine.publicationYear;
    }
